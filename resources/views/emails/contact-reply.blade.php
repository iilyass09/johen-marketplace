                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%;max-width:600px;background-color:#ffffff !important;">
                    ...
                    <tr>
                        <td align="left" style="padding:28px 40px;">
                            <p style="margin:0 0 14px;font-size:15px;color:#111827;">Halo <strong>{{ $inquiry->name }}</strong>,</p>
                            <p style="margin:0 0 24px;font-size:14px;line-height:1.6;color:#6B7280;">Terima kasih telah menghubungi Johen Gaming. Berikut balasan dari tim CS kami:</p>
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#f9fafb !important;border:1px solid #E5E7EB;border-radius:12px;margin-bottom:24px;">
                                <tr>
                                    <td align="left" style="padding:20px 24px;">
                                        <p style="margin:0;font-size:14px;line-height:1.7;color:#111827;white-space:pre-wrap;">{{ $reply }}</p>
                                    </td>
                                </tr>
                            </table>
                            <p style="margin:0;font-size:13px;line-height:1.6;color:#6B7280;">Jika Anda memiliki pertanyaan lebih lanjut, jangan ragu untuk menghubungi kami kembali melalui halaman kontak di website.</p>
                        </td>
                    </tr>
                    <tr>
